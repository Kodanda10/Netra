  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardGrid>
        ...
        <GlassCard className="col-span-12 lg:col-span-3" rows={2} title="Top Tweets by Favorites" subtitle="Twitter">
        ...
        <GlassCard className="col-span-12 lg:col-span-3" rows={2} title="Top Posts by Engaged Users" subtitle="Facebook">
